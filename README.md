...
![Build Status](https://github.com/bnu0/terraform-provider-kubectl/actions/workflows/build.yml/badge.svg) [![user guide](https://img.shields.io/badge/-user%20guide-blue)](https://registry.terraform.io/providers/bnu0/kubectl)
...
See [User Guide](https://registry.terraform.io/providers/bnu0/kubectl/latest) for details on installation and all the provided data and resource types.
...
```sh
$ go get github.com/bnu0/terraform-provider-kubectl
```

Enter the provider directory and build the provider

```sh
$ cd $GOPATH/src/github.com/bnu0/terraform-provider-kubectl
$ make build
```
